...
struct basic_file_wrapper:public T
{
	...
	explicit basic_file_wrapper(pathtype const& filename,open_mode om=interface_mode,perms pm=static_cast<perms>(436)):T(filename,om|interface_mode,pm){}
	template<::fast_io::constructible_to_os_c_str pathtype>
	explicit basic_file_wrapper(native_at_entry nate,pathtype const& filename,open_mode om=interface_mode,perms pm=static_cast<perms>(436)):T(nate,filename,om|interface_mode,pm){}
};
