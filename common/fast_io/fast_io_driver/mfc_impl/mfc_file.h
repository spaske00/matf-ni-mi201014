...
template<std::integral T>
inline void write(basic_mfc_io_observer<T> hd,io_scatters_t scatters)
{
...
public:
	...
	basic_mfc_file(basic_mfc_file const& mcf):basic_mfc_io_observer<T>{mcf.phandle->Duplicate()}{}
	...
	basic_mfc_file(basic_mfc_file&& mcf) noexcept:basic_mfc_io_observer<T>{mcf.phandle}
	{
		mcf.phandle=nullptr;
	}
